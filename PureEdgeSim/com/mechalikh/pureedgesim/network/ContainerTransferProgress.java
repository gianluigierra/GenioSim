...
public class ContainerTransferProgress{
	public enum Type {
		CONTAINER, CONTAINER_UNPLACEMENT, RESULTS_TO_DEV, UNPLACEMENT_RESULTS_TO_DEV, RESULTS_TO_ORCH, UNPLACEMENT_RESULTS_TO_ORCH,  RESULT_FROM_CLOUD_TO_EDGE, UNPLACEMENT_RESULT_FROM_CLOUD_TO_EDGE, REQUEST, UNPLACEMENT_REQUEST
	}
	...
	public ContainerTransferProgress(Container container, double fileSize, Type type) {
	...
	public ContainerTransferProgress setVertexList(List<ComputingNode> vertexList) {
	...
	public ContainerTransferProgress setEdgeList(List<NetworkLink> edgeList) {
